...
class TColor {
  static Color get primary => const Color(0xff2378c4);
  static Color get primary500 => const Color(0xffffae00);
  static Color get primary20 => const Color(0xffbbb2e9);
  ...
  static Color get secondary => const Color(0xff7bff00);
